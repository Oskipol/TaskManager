      ...
      >
        ...
        <div class="flex gap-5">
          ...
          >
            ...
            <div class="h-full aspect-square bg-[url('/taskmanager/plus.png')] bg-cover bg-center block md:hidden"></div>
          </button>
          <button
          ...
          >
            ...
            <div class="h-full aspect-square bg-[url('/taskmanager/arrow.png')] bg-cover bg-center block md:hidden"></div>
          </button>
          <div class="w-10 aspect-square flex justify-center items-center cursor-pointer hover:rotate-180 duration-300" (click)="SettingsMode.set(true)" style="background-image: url('/taskmanager/gear.png'); background-size: cover; background-position: center;"><div class="w-[40%] h-[40%] rounded-[50%] bg-gray-700"></div></div>
        </div>
      </div>
